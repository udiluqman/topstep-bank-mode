const BANKMODE_VERSION = "v12.3-ritual3m-stable";
...
function ritualModalHTML(){
  ...
  <div class="modal" onclick="closeRitual()">
    <div class="modalCard" onclick="event.stopPropagation()">
      ...
      <button class="btn btn-primary" style="display:${showCommit ? "inline-flex":"none"}" onclick="ritualCommit()">I PROTECT CAPITAL</button>
      <button class="btn" onclick="closeRitual()">Close</button>
    </div>
  </div>`;
}
