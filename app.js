...
function pageHome(){
  ...
  const ritualDone2 = (state.ritual && state.ritual.lastDone === todayStr());
  const ritualHomeCard = `
    <div class="card">
      <div class="row between" style="align-items:center;">
        ...
        <button class="btn primary ${ritualDone2 ? "" : "pulse"}" onclick="openRitual()" ${ritualDone2 ? "disabled" : ""}>${ritualDone2 ? "Done ✅" : "Start (10s)"}</button>
      </div>
    </div>
  `;
