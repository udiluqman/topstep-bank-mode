...
function pageHome(){
  ...
  const tokenState = (state.protect.active && state.protect.date===todayStr()) ? "LOCKED" : (ttd>=1 ? "USED" : "AVAILABLE");
  ...
  const focus = tokenState==="AVAILABLE"
    ...
    : (tokenState==="USED" ? "Token spent. Bank is closed." : "Protect mode. Bank is closed.");
    ...
    <div class="page">
      ...
      <div class="grid">
        <div class="card big">
          ...
          <div class="token ${tokenClass}">${tokenState}</div>
          <div class="muted small">${focus}</div>
          <div class="row" style="margin-top:10px;gap:10px;">
            <a class="btn primary" href="#behavior">${tokenState==="AVAILABLE" ? "Mark Green ✅" : "Review Streak"}</a>
